...
$tahun = (int)($_GET['tahun'] ?? getSetting($pdo,'pengabdian_tahun') ?: date('Y'));
...
$nama_lppm  = $cfg['nama_lppm']      ?: 'Lembaga Pengabdian dan Pengabdian kepada Masyarakat (LPPM)';
...
<head>
<meta charset="UTF-8">
<title>Laporan Pengabdian — <?= $tahun ?></title>
<style>
...
<div id="toolbar">
  <div class="tb-left">
    ...
    <div>
      <h1>Laporan Pengabdian — Tahun Anggaran <?= $tahun ?></h1>
      <small>Dicetak: <?= $cetak_tgl ?> · oleh <?= htmlspecialchars($printer) ?></small>
    </div>
  </div>
  <div>
    <a href="<?= BASE_URL ?>/admin/pengabdian_laporan.php" class="tb-btn tb-back">← Kembali</a>
...
<div id="wrap">
  <div class="sheet">
    ...
    <div class="title-wrap">
      ...
      <div class="title-main">Rekap Pelaksanaan & Pelaporan Pengabdian</div>
